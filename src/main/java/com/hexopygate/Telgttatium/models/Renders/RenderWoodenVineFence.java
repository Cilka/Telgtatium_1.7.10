...
import com.hexopygate.Telgttatium.models.ModelWoodenVineFence;
...
public class RenderWoodenVineFence extends TileEntitySpecialRenderer{
protected ModelWoodenVineFence fence;
protected ResourceLocation texture;
	@Override
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z,
			float scale) {
		// TODO Auto-generated method stub
		TEWoodVineFence fence= (TEWoodVineFence)tile;
	...
	public RenderWoodenVineFence()
	{
		
		fence= new ModelWoodenVineFence();
