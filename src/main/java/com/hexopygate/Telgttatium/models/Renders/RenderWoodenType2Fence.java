...
import com.hexopygate.Telgttatium.models.ModelWoodenType2Fence;
...
public class RenderWoodenType2Fence extends TileEntitySpecialRenderer{
protected ModelWoodenType2Fence fence;
protected ResourceLocation texture;
	@Override
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z,
			float scale) {
		// TODO Auto-generated method stub
		TEWoodType2Fence fence= (TEWoodType2Fence)tile;
	...
	public RenderWoodenType2Fence()
	{
		
		fence= new ModelWoodenType2Fence();
