...
import com.hexopygate.Telgttatium.models.ModelBambooFence;
...
public class RenderBambooFence extends TileEntitySpecialRenderer{
protected ModelBambooFence fence;
protected ResourceLocation texture;
	@Override
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z,
			float scale) {
		// TODO Auto-generated method stub
		TEFence fence= (TEFence)tile;
	...
	public RenderBambooFence()
	{
		
		fence= new ModelBambooFence();
