...
import com.hexopygate.Telgttatium.models.ModelDecoFence;
...
public class RenderDecoFence extends TileEntitySpecialRenderer{
protected ModelDecoFence fence;
protected ResourceLocation texture;
	@Override
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z,
			float scale) {
		// TODO Auto-generated method stub
		TEDecoFence fence= (TEDecoFence)tile;
	...
	public RenderDecoFence()
	{
		
		fence= new ModelDecoFence();
