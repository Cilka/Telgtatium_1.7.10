...
public  class TelGenLayer extends GenLayer
{
	public TelGenLayer(long seed){
		super(seed);
	}
...
/*
	  private List<BiomeEntry>[] biomes = new ArrayList[BiomeManager.BiomeType.values().length];
	    ...
	    public TelGenLayerBiome(long p_i2122_1_, GenLayer p_i2122_3_, WorldType p_i2122_4_)
	    {
	        super(p_i2122_1_);
	        ...
	        if (p_i2122_4_ == WorldType.DEFAULT_1_1)
	        {
	           ...
	           // biomes[desertIdx].add(new BiomeEntry(BiomeRegistry.base, 10));
	  	      
	        }
	        else if (p_i2122_4_ instanceof WorldTypeTelgttatium)
	        {
	            //biomes[desertIdx].add(new BiomeEntry(BiomeGenBase.desert, 30));
	           // biomes[desertIdx].add(new BiomeEntry(BiomeGenBase.savanna, 20));
	            //biomes[desertIdx].add(new BiomeEntry(BiomeGenBase.plains, 10));
	           // biomes[desertIdx].add(new BiomeEntry(BiomeRegistry.base, 10));
	        	biomes[warmIdx].add(new BiomeEntry(new BiomeGenForrest(200), 0));
	        }
	    }
