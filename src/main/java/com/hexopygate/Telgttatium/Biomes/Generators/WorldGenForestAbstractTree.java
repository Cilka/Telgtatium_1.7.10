package com.hexopygate.Telgttatium.Biomes.Generators;

import java.util.Random;

import com.hexopygate.Telgttatium.blockarchtype.TelGrass;
...
public abstract class WorldGenForestAbstractTree extends WorldGenerator {
	 ...
	 @SuppressWarnings("unused")
	    ...
	    {
	        return p_150523_1_.getMaterial() == Material.air || p_150523_1_.getMaterial() == Material.leaves || p_150523_1_ instanceof TelGrass || p_150523_1_ instanceof TelGrassHD || p_150523_1_ == Blocks.sapling || p_150523_1_ == Blocks.vine;
	    }
