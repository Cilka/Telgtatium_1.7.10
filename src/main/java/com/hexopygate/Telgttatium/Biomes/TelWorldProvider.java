...
import com.hexopygate.Telgttatium.Dimension.DimensionIDs;
...
public class TelWorldProvider extends WorldProvider
{
	@Override
	/** tells Minecraft to use our new Terrain Generator */
	public IChunkProvider createChunkGenerator() {
		return new TelChunkGenerator(this.worldObj, this.worldObj.getSeed(), true);
	}
	...
	public void registerWorldChunkManager() {
		...
		this.dimensionId = DimensionIDs.HEPOXYSTELGTTATIUM;
	}
	
	/** Get Provider for Dimension **/
	public static WorldProvider getProviderForDimension(int id)
	{
		return DimensionManager.createProviderFor(DimensionIDs.HEPOXYSTELGTTATIUM);
	}
	...
	public String getSaveFolder() {
			return "DIM" +DimensionIDs.HEPOXYSTELGTTATIUM;
	}
