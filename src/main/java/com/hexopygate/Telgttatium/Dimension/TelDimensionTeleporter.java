...
public class TelDimensionTeleporter extends Teleporter {
    ...
    public TelDimensionTeleporter(WorldServer p_i1963_1_)
    {
    	super(p_i1963_1_);
	...
	public boolean placeInExistingPortal(Entity p_77184_1_, double p_77184_2_, double p_77184_4_, double p_77184_6_, float p_77184_8_)
    {
        ...
        {
        	TelDimensionTeleporter.PortalPosition portalposition = (TelDimensionTeleporter.PortalPosition)this.destinationCoordinateCache.getValueByKey(j1);
            d3 = 0.0D;
        ...
        if (d3 >= 0.0D)
        {
            if (flag)
            {
                this.destinationCoordinateCache.add(j1, new TelDimensionTeleporter.PortalPosition(i, j, k, this.worldServerInstance.getTotalWorldTime()));
        ...
        for (i3 = 0; i3 < 4; ++i3)
        {
            for (j3 = 0; j3 < 4; ++j3)
            {
                for (k3 = -1; k3 < 4; ++k3)
                {
                    ...
                    this.worldServerInstance.setBlock(l3, i4, j4, (Block)(flag ? Blocks.stone : Blocks.portal), 0, 2);
                }
            }
    ...
    public void removeStalePortalLocations(long p_85189_1_)
    {
        if (p_85189_1_ % 100L == 0L)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                TelDimensionTeleporter.PortalPosition portalposition = (TelDimensionTeleporter.PortalPosition)this.destinationCoordinateCache.getValueByKey(olong.longValue());
