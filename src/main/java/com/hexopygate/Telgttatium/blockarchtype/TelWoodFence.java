...
public class TelWoodFence extends BlockContainer{
 String name = null;
	protected TelWoodFence(Material p_i45394_1_) {
		super(p_i45394_1_);
	...
	TEWoodFence tile = (TEWoodFence) world.getTileEntity(x, y, z);
