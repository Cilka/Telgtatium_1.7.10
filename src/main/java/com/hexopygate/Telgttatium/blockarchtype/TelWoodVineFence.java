...
public class TelWoodVineFence extends BlockContainer{
 String name = null;
	protected TelWoodVineFence(Material p_i45394_1_) {
		super(p_i45394_1_);
	...
	TEWoodVineFence tile = (TEWoodVineFence) world.getTileEntity(x, y, z);
