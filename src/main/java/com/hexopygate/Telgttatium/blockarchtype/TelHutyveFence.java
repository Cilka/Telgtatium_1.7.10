...
public class TelHutyveFence extends BlockContainer{
 String name = null;
	protected TelHutyveFence(Material p_i45394_1_) {
		super(p_i45394_1_);
	...
	TEHutyveFence tile = (TEHutyveFence) world.getTileEntity(x, y, z);
