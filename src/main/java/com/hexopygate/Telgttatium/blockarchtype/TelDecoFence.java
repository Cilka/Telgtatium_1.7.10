...
public class TelDecoFence extends BlockContainer{
 String name = null;
	protected TelDecoFence(Material p_i45394_1_) {
		super(p_i45394_1_);
	...
	TEDecoFence tile = (TEDecoFence) world.getTileEntity(x, y, z);
