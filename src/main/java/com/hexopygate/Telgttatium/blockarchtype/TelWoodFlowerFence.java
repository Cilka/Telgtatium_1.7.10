...
public class TelWoodFlowerFence extends BlockContainer{
 String name = null;
	protected TelWoodFlowerFence(Material p_i45394_1_) {
		super(p_i45394_1_);
	...
	TEWoodFlowerFence tile = (TEWoodFlowerFence) world.getTileEntity(x, y, z);
