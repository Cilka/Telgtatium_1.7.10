...
public class Dark_Purple_Glass_Pane extends TelNormalGlassPane {

	public Dark_Purple_Glass_Pane(String texture) {
		super(texture);
		// TODO Auto-generated constructor stub
	}
public Dark_Purple_Glass_Pane(String faceTex, String trimTex) {
