...
public class Yellow_Glass_Pane extends TelNormalGlassPane {

	public Yellow_Glass_Pane(String texture) {
		super(texture);
		// TODO Auto-generated constructor stub
	}
public Yellow_Glass_Pane(String faceTex, String trimTex) {
